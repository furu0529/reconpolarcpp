    ...
    real(dl) :: fixq = 0 !Debug output of one q
    ...
    if (fixq/=0._dl) then
        ...
        call CreateTxtFile('evolve_k0.003_cs1.txt',1)
        do j=1,6000
           !tauend = taustart+(j-1)*(CP%tau0-taustart)/6000
           tauend = taustart* exp(j/6000._dl*log(CP%tau0/taustart))
            ...
            write (1,'(4E15.5)') y(1),y(3),y(4),y(EV%w_ix)
        end do
        close(1)
        stop
    end if
